...
# 查询定位
bash query-location.sh test-star-input.txt locations features/test-orb-3000 models

# 汇总定位结果
gawk -f sum-location.awk results/location-h-models.test-orb-3000.test-star-input.txt

# 转换坐标系
gawk -f transform-location.awk results/location-h-models.test-orb-3000.test-star-input.txt > results/location-results.txt
