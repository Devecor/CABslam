...
gawk -f region-errors.awk results/location-errors-n.txt > results/region-errors-n.txt
gawk -f region-errors.awk results/location-errors-f.txt > results/region-errors-f.txt
gawk -f region-errors.awk results/location-errors-h.txt > results/region-errors-h.txt
