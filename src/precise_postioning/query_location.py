...
from check_match import explore_match
...
def main(params=None):
    ...
    parser.add_argument('refimages', metavar='IMAGES', nargs='+', help='参考图片模型文件')
    ...
    parser.add_argument('--reject', type=int, default=6, help='匹配失败阀值，小于该值认为是失败,默认值为6')
    parser.add_argument('--accept', type=int, default=100, help='匹配成功阀值，大于该值认为匹配成功,默认值100')
